...
include { Make_SNV_list_SHIVER } from './Processes/make_snv_list'
...
workflow {
    ...
    if(params.mode == "shiver"){
        ...
        map = Map_Reads(Align_Contigs.out)
        Make_SNV_list_SHIVER(Channel.value(file(params.fasta)), map.collect())
